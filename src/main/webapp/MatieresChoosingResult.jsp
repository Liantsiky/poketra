...
<% List <ModeleMatiere> liste = (List<ModeleMatiere>)request.getAttribute("liste"); %>
...
<h4
            ...
            >
              Liste sac contenant la matiere : <%=liste.get(0).getMatiere().getDesignation() %>
            </h4>
                  ...
                  >
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-sm">
                       <%=modeleMatiere.getModele().getId() %>
                      </td>
                      <td class="px-4 py-3 text-sm">
                       <%=modeleMatiere.getModele().getConfectionMatieres().get(0).getQuantite() %>
                      </td>
                    </tr>
						<% } %>
