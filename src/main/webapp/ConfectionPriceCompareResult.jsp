...
<% List <ModelePrixConfection> liste = (List<ModelePrixConfection>)request.getAttribute("liste"); %>
...
<h4
            ...
            >
              Liste sac compris dont la necessite en matieres premieres est comprise entre <%=min %>  et <%=max %>
            </h4>
              ...
              <div class="w-full overfloout.println(lookMatiere.getMatiere().getDesignation()); w-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
					...
					<% for(ModelePrixConfection modelePrixConfection : liste) { %>
                    <tr class="text-gray-700 dark:text-gray-400">
                      
                      <td class="px-4 py-3 text-sm">
                       <%=modelePrixConfection.getModele().getId() %>
                      </td>
                      <td class="px-4 py-3 text-sm">
                       <%=modelePrixConfection.getTotal() %>
                      </td>
                    </tr>
						<% } %>
